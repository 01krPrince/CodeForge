...
import { Code2, Mail, Lock, User, Github, ArrowRight, Loader2, Eye, EyeOff } from "lucide-react";
...
export default function RegisterPage() {
  ...
  // Simple logic to show a green bar if password is > 6 chars
  const passwordStrength = formData.password.length > 0 
    ? (formData.password.length >= 8 ? 'w-full bg-emerald-500' : 'w-1/2 bg-amber-500')
    : 'w-0 bg-transparent';
  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative bg-[#050b14] overflow-hidden p-4">
      ...
      <div className="absolute top-1/4 -right-32 w-[500px] h-[500px] bg-teal-500/10 rounded-full mix-blend-screen blur-[120px] pointer-events-none" />
      <div className="absolute bottom-1/4 -left-32 w-[600px] h-[600px] bg-cyan-500/10 rounded-full mix-blend-screen blur-[150px] pointer-events-none" />
      ...
      <div className="relative w-full max-w-md z-10 my-8">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-neutral-400 text-sm">
            Start your journey to becoming a 100x engineer.
          </p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-2">
              ...
              <div className="h-1 w-full bg-white/5 rounded-full overflow-hidden mt-1.5">
                <div className={`h-full transition-all duration-300 ${passwordStrength}`} />
              </div>
            </div>
